  ...
  <tr onMouseOver="this.style.background='#D7E4F7'" onMouseOut="this.style.background='#EBF2F9';"  bgcolor="#EBF2F9">
    ...
    <td height="14" align="center" valign="middle" bgcolor="#f8f8f8"><?php echo $list['num4']; ?></td>
		...
		<td height="14" align="center" valign="middle" bgcolor="#f8f8f8"><?php 
                ...
                ?></td>
    <td height="14" align="center" valign="middle" bgcolor="#f8f8f8"><a href="mod.php?id=<?php echo $list['id']; ?>"><img src="../images/edit.gif" border="0" /></a>&nbsp;&nbsp;&nbsp;<a href="ok.php?id=<?php echo $list['id']; ?>&act=del" onClick="javascript:return confirm('确实要删除吗?')"><img src="../images/del.gif" border="0" /></a></td>
  </tr>
  <?php
  	}
  ?>
