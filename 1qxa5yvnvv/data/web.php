...
$sqlstr=get_sql("select * from {pre}ziliao order by id asc");
...
<table width="100%" height="22" border="0" cellpadding="0" cellspacing="1" bgcolor="#cccccc" style="margin:0 auto;padding-top:0px;">
  ...
  <tr>
    <td height="22" colspan="12" bgcolor="#555555"><font color="#FFFFFF">&nbsp;<strong>首页资料-<input type="text" name="sou" size="20" ><input type="submit" value="搜索"></strong></font></td>
  </tr>
  </form>
 </table> 
<div class="nav2">
